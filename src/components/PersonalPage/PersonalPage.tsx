    ...
    return (
      <div class="personal-page">
        ...
        <form class="text personal-page__settings-form">
          ...
          <div class="settings-form__form">
            <label htmlFor="password" class="input-label form__username-label">
              New password:
            </label>
            <input
              type="text"
              placeholder="Password"
              class="input-line form__password-label"
              id="username"
            />
            <label
          ...
          <div class="settings-form__form">
            <label htmlFor="confirm" class="input-label form__username-label">
              Confirm password:
            </label>
            <input
              type="text"
            ...
            />
            <label
              id="login__confirm-label_danger"
              class="input-label from__tooltip_danger invisible"
            >
